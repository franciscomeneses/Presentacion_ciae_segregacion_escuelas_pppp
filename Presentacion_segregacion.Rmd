...
__Variable dependiente:__ Segregación local, contribución de cada escuela a la segregación del país. Mide cuan sub y sobrerrepresentados se encuentra cada uno de los 5 grupos de NSE
...
library(kableExtra)
fit_indices %>% kbl(caption = "Tabla 1: Evidencia de invarianza longitudinal, ajustes y diferencias en los ajustes - cuarto grado") %>%
...
<div style="text-align:center;">
  <math display="block">
    <msub><mi>L</mi><mi>u</mi></msub>
    <mo>=</mo>
    <munderover>
      <mo>&#8721;</mo>
      <mrow><mi>g</mi><mo>=</mo><mn>1</mn></mrow>
      <mi>G</mi>
    </munderover>
    <msub><mi>p</mi><mrow><mi>g</mi><mo>|</mo><mi>u</mi></mrow></msub>
    <mo>&#x2062;</mo><!-- invisible times -->
    <mi>log</mi>
    <mfrac>
      <msub><mi>p</mi><mrow><mi>g</mi><mo>|</mo><mi>u</mi></mrow></msub>
      <msub><mi>p</mi><mrow><mo>&#183;</mo><mi>g</mi></mrow></msub>
    </mfrac>
  </math>
</div>
