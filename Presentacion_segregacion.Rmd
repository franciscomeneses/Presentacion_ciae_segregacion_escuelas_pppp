...
* El mejoramiento escolar es sumamente complejo y dificil de sostener, y un factor clave son liderazgos y los buenos docentes
...
* Paises con mayores niveles de segregación educativa logran peores resultados educativos
...
* Afecta las competencias civicas [(Janmaat, 2011)](https://doi.org/10.1177/0268580910393044)
...
* En los 2000 Chile tenia un Indice de Duncan de 0.6
  
  + Considerado tecnicamente como __hipersegregado__
...
* En comparación con otros paises de la región Chile se mantiene en el top de de segregación
 ...
 * Barreras economicas de entrada
 
 * Desiciones familiares
 
 * Practicas selectivas:
 ...
 * La Ley SEP - Subensión Escolar Preferencial (2008)
...
# ¿Cúal ha sido el efecto de estas politicas en la disminución de la segregación?
...
* __Variables__: 
  ...
  + _Quintiles de NSE_:  Mediante Analisis Factorial Confirmatorio (AFC) creamos un indice comparable en el tiempo con el cual construimos quintiles socioecnomicos.  
  
  + _La segregación_ Para medir la segregación utilizamos el _Indice de entropia de Theil_


*  __Métodos__: 

    * Analisis descriptivo: Indice de Theil 
    
    * Regressions multinivel de escuelas anidadas en comunas
...
__Variable dependiente:__ Contribución de cada escuela a la segregación del pais. Mide cuan sub y sobrerepresentados se encuentra cada uno de los 5 grupos de NSE
...
* Años
* Politicas publicas
  + __SEP__ Adscripcion de la escuela a la SEP  (Si/No)
  + __SAE__ porcentaje de estudiantes que ingresaron por SAE (%)
  + __Fin copago__ con o sin copago, distinguiendo monto  ($)

__controles:__ segregacion territorial, Cantidad de estudiantes
...
* La variable va de 0 a 100

* __0%__:
    + significa que todos los quintiles estan igual de representados (20% de cada quintil)

* __100%__
    + que la escuela solo tiene estudiantes de un quintil en particular (20% de cada quintil)
    
* __Valores Intermedios__:
    + Algunos grupos estan sobrerepresentados y otros subrepresentados.
 ...
 *  El cambio en el tiempo no se exlpica al controlar por la segregación residencial
...
* La disminución de la segregación se explica más por las políticas que por cambios demograficos
 ...
 * Existen varios estudios sobre este tema y suelen no encontrar efectos. 
      ...
      + Tambien utilizan indicadores menos sensibles a los cambios como Duncan 
 ...
 * Es importante seguir estudianto la temática
